defmodule ShopWeb.ProductLiveTest do
  ...
  @create_attrs %{description: "some description", title: "some title", price: 42, photo: "some photo"}
  @update_attrs %{description: "some updated description", title: "some updated title", price: 43, photo: "some updated photo"}
  @invalid_attrs %{description: nil, title: nil, price: nil, photo: nil}
